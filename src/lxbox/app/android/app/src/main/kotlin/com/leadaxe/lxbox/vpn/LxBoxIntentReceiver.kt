...
class LxBoxIntentReceiver : BroadcastReceiver() {
    ...
    companion object {
        ...
        const val ACTION_START_VPN = "com.deltakronecker.deltaray.START_VPN"
        const val ACTION_STOP_VPN = "com.deltakronecker.deltaray.STOP_VPN"
        const val ACTION_TOGGLE_VPN = "com.deltakronecker.deltaray.TOGGLE_VPN"
        const val ACTION_SWITCH_NODE = "com.deltakronecker.deltaray.SWITCH_NODE"
        const val ACTION_SET_GROUP = "com.deltakronecker.deltaray.SET_GROUP"
        const val ACTION_REBUILD_CONFIG = "com.deltakronecker.deltaray.REBUILD_CONFIG"
        const val ACTION_REFRESH_SUBS = "com.deltakronecker.deltaray.REFRESH_SUBS"
        const val ACTION_RESET_NETWORK = "com.deltakronecker.deltaray.RESET_NETWORK"
        const val ACTION_URLTEST_GROUP = "com.deltakronecker.deltaray.URLTEST_GROUP"
